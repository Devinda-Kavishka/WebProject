...
<center>
<table border="1px solid black;" style="margin-top: -520px; margin-left:350px; margin-right:150px;">
...
<textarea name="response" placeholder="Write response..." style="width:150px;"></textarea><br>
